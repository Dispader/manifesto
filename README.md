...
[![Release](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://plugins.gradle.org/plugin/com.github.dispader.manifesto) [![Build Status](https://travis-ci.org/Dispader/manifesto.svg?branch=master)](https://travis-ci.org/Dispader/manifesto) [![Dependency Status](https://www.versioneye.com/user/projects/576d52ad7bc681003c4900aa/badge.svg?style=flat-square)](https://www.versioneye.com/user/projects/576d52ad7bc681003c4900aa)
...
```groovy
plugins {
    id 'com.github.dispader.manifesto' version '1.0.0'
}
```
...
buildscript {
    ...
    dependencies {
        classpath 'com.github.dispader:manifesto:1.0.0'
    }
}
...
[![semver](http://img.shields.io/:semver-1.0.0-blue.svg)](http://semver.org)
