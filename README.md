...
```groovy
plugins {
    id 'com.github.dispader.manifesto' version '1.0.3'
}
```
...
buildscript {
    ...
    dependencies {
        classpath 'com.github.dispader:manifesto:1.0.3'
    }
}
...
[![semver](http://img.shields.io/:semver-1.0.3-blue.svg)](http://semver.org)
