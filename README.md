...
```groovy
plugins {
    id 'com.github.dispader.manifesto' version '0.7.0'
}
```
...
buildscript {
    ...
    dependencies {
        classpath 'com.github.dispader:manifesto:0.7.0'
    }
}
...
[![semver](http://img.shields.io/:semver-0.7.0-blue.svg)](http://semver.org)
